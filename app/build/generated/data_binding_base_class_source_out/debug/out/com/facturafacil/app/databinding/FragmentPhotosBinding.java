...
public final class FragmentPhotosBinding implements ViewBinding {
  ...
  private FragmentPhotosBinding(@NonNull LinearLayout rootView, @NonNull TextView photoDescription,
      @NonNull RecyclerView photosRecyclerView) {
  ...
  public static FragmentPhotosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPhotosBinding((LinearLayout) rootView, photoDescription,
          photosRecyclerView);
    }
